...
출처: https://epthffh.tistory.com/entry/통화형식-3자리-콤마-사용하기-예제 [물고기 개발자의 블로그]
	...
	$(document).ready(function() {
		...
		function selectWishList(data) {
			...
			let div = $('<div />');
			let button = $('<button />').addClass('btn btn-outline-dark btn-sm').attr('type', 'button').attr('id', 'delBtn' + data.wNo);
		...
		//이거 처리를 어떻게 해야하는거지..... delBtn이 안먹는다......
